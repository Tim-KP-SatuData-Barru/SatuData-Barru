    ...
    <div className="flex flex-row border bg-white p-5 mx-16 hover:bg-neutral-300 cursor-pointer" onClick={() => data.onClick(data.card)}>
      ...
      <div className="w-[100%] mx-5 flex flex-col gap-3 ">
        ...
        <div className="flex flex-row gap-5">
          <div className="flex flex-row bg-orange rounded-2xl px-2 py-1 w-[20%] items-center gap-2">
          ...
          <div className="flex flex-row bg-lime-500 rounded-2xl px-2 py-1 w-[20%] gap-2 " >
            <Image alt="logo" src="/images/dataset/PriceTag.png" width={15} height={15} />
            <p className="text-white text-xs line-clamp-1">{data.card.sektor_kegiatan}</p>
          </div>
        </div>
      </div>
    </div>
